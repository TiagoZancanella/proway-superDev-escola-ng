...
export class CursoCadastroComponent {
  ...
  cadastrar(){
    this.cursoService.cadastrar(this.curso).subscribe({
      ...
      error: erro => console.log("Ocorreu um erro ao cadastar o aluno:" + erro),
    })
  }
  private apresentarMensagemCadastrado(){
    this.messageService.add({ severity:"sucess", summary: "sucesso", detail: "Curso Cadastrado com sucesso"});
